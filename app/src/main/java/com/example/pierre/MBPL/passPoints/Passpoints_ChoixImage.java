...
public class Passpoints_ChoixImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passpoints__choix_image);
        ...
        for (int i = 0; i < tabImages.size(); i++) {
            ...
            iv.setOnClickListener(new ImageView.OnClickListener() {
                ...
                public void onClick(View v) {
                    //Toast.makeText(Passpoints_ChoixImage.this, "" + tabImages.get(j), Toast.LENGTH_SHORT).show();
                    //((ImageView)v).setImageBitmap(bmp2);
                    Intent appel = new Intent(Passpoints_ChoixImage.this, Passpoints_ChoixPoints.class);
